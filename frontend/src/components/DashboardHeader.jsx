  ...
  return (
    <div className="w-full h-[4.5rem] flex justify-between items-center bg-white px-[2rem]">
      ...
      <div className="flex gap-[1rem] items-center">
        ...
        <div className="bg-gray-300 h-[3rem] w-[3rem] text-2xl font-bold rounded-[50%] flex items-center justify-center px-[1.3rem] cursor-pointer" onClick={() => onClick(prev => !prev)}>
          <div>{avatar}</div>
        </div>
      </div>
    </div>
